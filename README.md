...
Follow this guide to install and update FGA Preview using Obtainium: [Install via Obtainium](https://arthurkun21.github.io/FGA-Preview-Build/post/install-via-obtanium/)
